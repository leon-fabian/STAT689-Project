...
Evaluation:<br> 
Our final product did have drop down menu which included all the variables. One menu for the x axis and and one for the y axis. So far we have not implemented a way to display the pearson R value for a given plot as we had wanted to, instead we opted for a line of best fit.
