...
This analysis will be implemented as a *line graph* with range sliders for the year range. The `plotly` package will be used to execute this visualization.
...
A *racing bar chart* would allow us to visualize the accumulation of hybrids from each brand over the years. The racing bar chart would be implemented using the `ddplot` package in R. 
